  ...
  <section id="feature" class="tpl-section">
    <header class="tpl-section__head">
      ...
      <p class="tpl-section__desc">
        商品の特性を伝える複数レイアウトを用意しています。画像カード・アイコングリッド・画像＋リストに加え、フル幅ヒーロー＋仕様表、文案と2×2画像の分割、大画像とテキストの積み重ね、半幅ヒーロー＋サイド仕様、メイン＋サムネ付きギャラリーなどがあります。参照元は
        Tailwind UI の Product feature 系パターンです。アイコンは 64×64
