...
// `--preview-max-w` CSS variable — switching modes narrows the wrapper so
// operators can eyeball fixed widths without resizing the whole browser.
// Note: responsive layout in style.css is driven by viewport-based @media
// queries, so mobile/tablet layout still only fires at real browser widths.

const STORAGE_KEY = 'shopify-editor.previewMode.v1'

// Widths below are the intended `.pd-section` widths. The preview wrapper
